...
```
schemas-json/models/address.schema.json
```
...
| Property                    | Type     | Group                                                               |
| --------------------------- | -------- | ------------------------------------------------------------------- |
| [\_id](#_id)                | `string` | `schemas-json/models/address.schema.json#/definitions/MetroStation` |
| [description](#description) | `string` | `schemas-json/models/address.schema.json#/definitions/MetroStation` |
| [name](#name)               | `string` | `schemas-json/models/address.schema.json#/definitions/MetroStation` |
