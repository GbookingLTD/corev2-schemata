...
class CancelAppointmentByBusinessParams:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'CancelAppointmentByBusinessParams':
        assert isinstance(obj, dict)
        ...
        return CancelAppointmentByBusinessParams(appointment, client)
...
class AppointmentCancelAppointmentByBusinessRequest:
    ...
    def __init__(self, cred: Optional[Cred], id: Union[float, str], jsonrpc: str, method: str, params: CancelAppointmentByBusinessParams) -> None:
        self.cred = cred
        self.id = id
        self.jsonrpc = jsonrpc
        self.method = method
    ...
    def from_dict(obj: Any) -> 'AppointmentCancelAppointmentByBusinessRequest':
        ...
        jsonrpc = from_str(obj.get("jsonrpc"))
        method = from_str(obj.get("method"))
        params = CancelAppointmentByBusinessParams.from_dict(obj.get("params"))
    ...
    def to_dict(self) -> dict:
        ...
        result["jsonrpc"] = from_str(self.jsonrpc)
        result["method"] = from_str(self.method)
        result["params"] = to_class(CancelAppointmentByBusinessParams, self.params)
        return result
...
class CancelAppointmentByClientParams:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'CancelAppointmentByClientParams':
        assert isinstance(obj, dict)
        ...
        return CancelAppointmentByClientParams(appointment, client)
...
class AppointmentCancelAppointmentByClientRequest:
    ...
    def __init__(self, cred: Optional[Cred], id: Union[float, str], jsonrpc: str, method: str, params: CancelAppointmentByClientParams) -> None:
        self.cred = cred
        self.id = id
        self.jsonrpc = jsonrpc
        self.method = method
    ...
    def from_dict(obj: Any) -> 'AppointmentCancelAppointmentByClientRequest':
        ...
        jsonrpc = from_str(obj.get("jsonrpc"))
        method = from_str(obj.get("method"))
        params = CancelAppointmentByClientParams.from_dict(obj.get("params"))
    ...
    def to_dict(self) -> dict:
        ...
        result["jsonrpc"] = from_str(self.jsonrpc)
        result["method"] = from_str(self.method)
        result["params"] = to_class(CancelAppointmentByClientParams, self.params)
        return result
...
class TentacledAppointment:
    ...
    def __init__(self, client_appear: AppointmentClientAppear, id: str) -> None:
    ...
    def from_dict(obj: Any) -> 'TentacledAppointment':
        ...
        id = from_str(obj.get("id"))
        return TentacledAppointment(client_appear, id)
...
class ClientAppearParams:
    appointment: TentacledAppointment
    business: PurpleBusiness

    def __init__(self, appointment: TentacledAppointment, business: PurpleBusiness) -> None:
        self.appointment = appointment
        self.business = business

    @staticmethod
    def from_dict(obj: Any) -> 'ClientAppearParams':
        assert isinstance(obj, dict)
        appointment = TentacledAppointment.from_dict(obj.get("appointment"))
        business = PurpleBusiness.from_dict(obj.get("business"))
        return ClientAppearParams(appointment, business)
...
class AppointmentClientAppearRequest:
    """авторизационные параметры"""
    cred: Optional[Cred]
    """значение числового типа для идентификации запроса на сервере"""
    id: Union[float, str]
    ...
    def __init__(self, cred: Optional[Cred], id: Union[float, str], jsonrpc: str, method: str, params: ClientAppearParams) -> None:
        self.cred = cred
        self.id = id
        self.jsonrpc = jsonrpc
        self.method = method
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppointmentClientAppearRequest':
        assert isinstance(obj, dict)
        cred = from_union([Cred.from_dict, from_none], obj.get("cred"))
        id = from_union([from_float, from_str], obj.get("id"))
        jsonrpc = from_str(obj.get("jsonrpc"))
        method = from_str(obj.get("method"))
        params = ClientAppearParams.from_dict(obj.get("params"))
        return AppointmentClientAppearRequest(cred, id, jsonrpc, method, params)
    ...
    def to_dict(self) -> dict:
        ...
        result["jsonrpc"] = from_str(self.jsonrpc)
        result["method"] = from_str(self.method)
        result["params"] = to_class(ClientAppearParams, self.params)
        return result


class AppointmentClientAppearResponseError:
    """объект, содержащий информацию об ошибке
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppointmentClientAppearResponseError':
        assert isinstance(obj, dict)
        code = from_float(obj.get("code"))
        data = from_union([from_str, lambda x: from_dict(lambda x: x, x), from_none], obj.get("data"))
        message = from_str(obj.get("message"))
        return AppointmentClientAppearResponseError(code, data, message)
...
class AppointmentClientAppearResponse:
    """значение числового типа для идентификации запроса на сервере"""
    id: float
    """версия протокола (2.0)"""
    jsonrpc: str
    ...
    result: Optional[bool]
    """объект, содержащий информацию об ошибке"""
    error: Optional[AppointmentClientAppearResponseError]

    def __init__(self, id: float, jsonrpc: str, result: Optional[bool], error: Optional[AppointmentClientAppearResponseError]) -> None:
        self.id = id
        self.jsonrpc = jsonrpc
        self.result = result
        self.error = error
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppointmentClientAppearResponse':
        assert isinstance(obj, dict)
        id = from_float(obj.get("id"))
        jsonrpc = from_str(obj.get("jsonrpc"))
        result = from_union([from_bool, from_none], obj.get("result"))
        error = from_union([AppointmentClientAppearResponseError.from_dict, from_none], obj.get("error"))
        return AppointmentClientAppearResponse(id, jsonrpc, result, error)
    ...
    def to_dict(self) -> dict:
        ...
        result["jsonrpc"] = from_str(self.jsonrpc)
        result["result"] = from_union([from_bool, from_none], self.result)
        result["error"] = from_union([lambda x: to_class(AppointmentClientAppearResponseError, x), from_none], self.error)
        return result
...
class ClientAppear:
    ...
    def __init__(self, request: AppointmentClientAppearRequest, response: AppointmentClientAppearResponse) -> None:
        self.request = request
        self.response = response

    @staticmethod
    def from_dict(obj: Any) -> 'ClientAppear':
        assert isinstance(obj, dict)
        request = AppointmentClientAppearRequest.from_dict(obj.get("request"))
        response = AppointmentClientAppearResponse.from_dict(obj.get("response"))
        return ClientAppear(request, response)

    def to_dict(self) -> dict:
        result: dict = {}
        result["request"] = to_class(AppointmentClientAppearRequest, self.request)
        result["response"] = to_class(AppointmentClientAppearResponse, self.response)
        return result
...
class StickyAppointment:
    ...
    def from_dict(obj: Any) -> 'StickyAppointment':
        ...
        return StickyAppointment(id, reminder, source)
...
class PurpleContract:
    client_contract_id: Optional[str]
    contract_id: Optional[str]
    id: Optional[str]

    def __init__(self, client_contract_id: Optional[str], contract_id: Optional[str], id: Optional[str]) -> None:
        self.client_contract_id = client_contract_id
        self.contract_id = contract_id
        self.id = id

    @staticmethod
    def from_dict(obj: Any) -> 'PurpleContract':
        assert isinstance(obj, dict)
        client_contract_id = from_union([from_str, from_none], obj.get("clientContractID"))
        contract_id = from_union([from_str, from_none], obj.get("contractID"))
        id = from_union([from_str, from_none], obj.get("id"))
        return PurpleContract(client_contract_id, contract_id, id)

    def to_dict(self) -> dict:
        result: dict = {}
        result["clientContractID"] = from_union([from_str, from_none], self.client_contract_id)
...
class ConfirmAppointmentParams:
    ...
    contract: Optional[PurpleContract]

    def __init__(self, appointment: StickyAppointment, client: TentacledClient, contract: Optional[PurpleContract]) -> None:
        self.appointment = appointment
        self.client = client
        self.contract = contract

    @staticmethod
    def from_dict(obj: Any) -> 'ConfirmAppointmentParams':
        assert isinstance(obj, dict)
        appointment = StickyAppointment.from_dict(obj.get("appointment"))
        client = TentacledClient.from_dict(obj.get("client"))
        contract = from_union([PurpleContract.from_dict, from_none], obj.get("contract"))
        return ConfirmAppointmentParams(appointment, client, contract)

    def to_dict(self) -> dict:
        result: dict = {}
        result["appointment"] = to_class(StickyAppointment, self.appointment)
        result["client"] = to_class(TentacledClient, self.client)
        result["contract"] = from_union([lambda x: to_class(PurpleContract, x), from_none], self.contract)
        return result
...
class AppointmentClientConfirmAppointmentRequest:
    ...
    def __init__(self, cred: Optional[Cred], id: Union[float, str], jsonrpc: str, method: str, params: ConfirmAppointmentParams) -> None:
        self.cred = cred
        self.id = id
        self.jsonrpc = jsonrpc
        self.method = method
    ...
    def from_dict(obj: Any) -> 'AppointmentClientConfirmAppointmentRequest':
        ...
        jsonrpc = from_str(obj.get("jsonrpc"))
        method = from_str(obj.get("method"))
        params = ConfirmAppointmentParams.from_dict(obj.get("params"))
    ...
    def to_dict(self) -> dict:
        ...
        result["jsonrpc"] = from_str(self.jsonrpc)
        result["method"] = from_str(self.method)
        result["params"] = to_class(ConfirmAppointmentParams, self.params)
        return result
...
class AppointmentContract:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppointmentContract':
        assert isinstance(obj, dict)
        client_contract_id = from_union([from_str, from_none], obj.get("clientContractID"))
        contract_id = from_union([from_str, from_none], obj.get("contractID"))
        id = from_union([from_str, from_none], obj.get("id"))
        return AppointmentContract(client_contract_id, contract_id, id)
...
class Appointment:
    ...
    color: Optional[str]
    contract: Optional[AppointmentContract]
    ...
    def from_dict(obj: Any) -> 'Appointment':
        ...
        contract = from_union([AppointmentContract.from_dict, from_none], obj.get("contract"))
    ...
    def to_dict(self) -> dict:
        ...
        result["contract"] = from_union([lambda x: to_class(AppointmentContract, x), from_none], self.contract)
        ...
        result["third_party"] = from_union([lambda x: from_list(lambda x: from_dict(lambda x: x, x), x), from_none], self.third_party)
        result["utm"] = from_union([lambda x: from_dict(lambda x: x, x), from_none], self.utm)
...
class RemoveEmptyAppointment:
    ...
    def __init__(self, appointment: IndigoAppointment, business: FluffyBusiness) -> None:
        self.appointment = appointment
        self.business = business
...
class IndecentAppointment:
    finish: Optional[str]
    id: str

    def __init__(self, finish: Optional[str], id: str) -> None:
        self.finish = finish
        self.id = id

    @staticmethod
    def from_dict(obj: Any) -> 'IndecentAppointment':
        assert isinstance(obj, dict)
        finish = from_union([from_str, from_none], obj.get("finish"))
        id = from_str(obj.get("id"))
        return IndecentAppointment(finish, id)

    def to_dict(self) -> dict:
        result: dict = {}
        result["finish"] = from_union([from_str, from_none], self.finish)
        result["id"] = from_str(self.id)
        return result
...
class FinishAppointmentParams:
    appointment: IndecentAppointment
    business: TentacledBusiness

    def __init__(self, appointment: IndecentAppointment, business: TentacledBusiness) -> None:
        self.appointment = appointment
        self.business = business

    @staticmethod
    def from_dict(obj: Any) -> 'FinishAppointmentParams':
        assert isinstance(obj, dict)
        appointment = IndecentAppointment.from_dict(obj.get("appointment"))
        business = TentacledBusiness.from_dict(obj.get("business"))
        return FinishAppointmentParams(appointment, business)

    def to_dict(self) -> dict:
        result: dict = {}
        result["appointment"] = to_class(IndecentAppointment, self.appointment)
        result["business"] = to_class(TentacledBusiness, self.business)
        return result


class AppointmentFinishAppointmentRequest:
    """авторизационные параметры"""
    cred: Optional[Cred]
    """значение числового типа для идентификации запроса на сервере"""
    id: Union[float, str]
    ...
    def __init__(self, cred: Optional[Cred], id: Union[float, str], jsonrpc: str, method: str, params: FinishAppointmentParams) -> None:
        self.cred = cred
        self.id = id
        self.jsonrpc = jsonrpc
        self.method = method
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppointmentFinishAppointmentRequest':
        assert isinstance(obj, dict)
        cred = from_union([Cred.from_dict, from_none], obj.get("cred"))
        id = from_union([from_float, from_str], obj.get("id"))
        jsonrpc = from_str(obj.get("jsonrpc"))
        method = from_str(obj.get("method"))
        params = FinishAppointmentParams.from_dict(obj.get("params"))
        return AppointmentFinishAppointmentRequest(cred, id, jsonrpc, method, params)
    ...
    def to_dict(self) -> dict:
        ...
        result["jsonrpc"] = from_str(self.jsonrpc)
        result["method"] = from_str(self.method)
        result["params"] = to_class(FinishAppointmentParams, self.params)
        return result


class AppointmentFinishAppointmentResponseError:
    """объект, содержащий информацию об ошибке
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppointmentFinishAppointmentResponseError':
        assert isinstance(obj, dict)
        code = from_float(obj.get("code"))
        data = from_union([from_str, lambda x: from_dict(lambda x: x, x), from_none], obj.get("data"))
        message = from_str(obj.get("message"))
        return AppointmentFinishAppointmentResponseError(code, data, message)
...
class AppointmentFinishAppointmentResponse:
    """значение числового типа для идентификации запроса на сервере"""
    id: float
    """версия протокола (2.0)"""
    jsonrpc: str
    ...
    result: Optional[bool]
    """объект, содержащий информацию об ошибке"""
    error: Optional[AppointmentFinishAppointmentResponseError]

    def __init__(self, id: float, jsonrpc: str, result: Optional[bool], error: Optional[AppointmentFinishAppointmentResponseError]) -> None:
        self.id = id
        self.jsonrpc = jsonrpc
        self.result = result
        self.error = error
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppointmentFinishAppointmentResponse':
        assert isinstance(obj, dict)
        id = from_float(obj.get("id"))
        jsonrpc = from_str(obj.get("jsonrpc"))
        result = from_union([from_bool, from_none], obj.get("result"))
        error = from_union([AppointmentFinishAppointmentResponseError.from_dict, from_none], obj.get("error"))
        return AppointmentFinishAppointmentResponse(id, jsonrpc, result, error)
    ...
    def to_dict(self) -> dict:
        ...
        result["jsonrpc"] = from_str(self.jsonrpc)
        result["result"] = from_union([from_bool, from_none], self.result)
        result["error"] = from_union([lambda x: to_class(AppointmentFinishAppointmentResponseError, x), from_none], self.error)
        return result


class FinishAppointment:
    request: AppointmentFinishAppointmentRequest
    response: AppointmentFinishAppointmentResponse

    def __init__(self, request: AppointmentFinishAppointmentRequest, response: AppointmentFinishAppointmentResponse) -> None:
        self.request = request
        self.response = response

    @staticmethod
    def from_dict(obj: Any) -> 'FinishAppointment':
        assert isinstance(obj, dict)
        request = AppointmentFinishAppointmentRequest.from_dict(obj.get("request"))
        response = AppointmentFinishAppointmentResponse.from_dict(obj.get("response"))
        return FinishAppointment(request, response)

    def to_dict(self) -> dict:
        result: dict = {}
        result["request"] = to_class(AppointmentFinishAppointmentRequest, self.request)
        result["response"] = to_class(AppointmentFinishAppointmentResponse, self.response)
        return result
...
class FluffyContract:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FluffyContract':
        assert isinstance(obj, dict)
        extra_id = from_union([from_str, from_none], obj.get("extraId"))
        id = from_union([from_str, from_none], obj.get("id"))
        return FluffyContract(extra_id, id)
...
class AppointmentGetAppointmentByFilterRequestParams:
    business: Optional[StickyBusiness]
    """данные по договору, если указано то будут переданы записи только по данному договору"""
    contract: Optional[FluffyContract]
    ...
    def __init__(self, business: Optional[StickyBusiness], contract: Optional[FluffyContract], extra_filters: Optional[PurpleExtraFilters], filter: Optional[PurpleFilter], network: Optional[PurpleNetwork], page: float, page_size: float, skip_business_cancelled: Optional[bool]) -> None:
        self.business = business
        self.contract = contract
    ...
    def from_dict(obj: Any) -> 'AppointmentGetAppointmentByFilterRequestParams':
        assert isinstance(obj, dict)
        business = from_union([StickyBusiness.from_dict, from_none], obj.get("business"))
        contract = from_union([FluffyContract.from_dict, from_none], obj.get("contract"))
        ...
        return AppointmentGetAppointmentByFilterRequestParams(business, contract, extra_filters, filter, network, page, page_size, skip_business_cancelled)

    def to_dict(self) -> dict:
        result: dict = {}
        result["business"] = from_union([lambda x: to_class(StickyBusiness, x), from_none], self.business)
        result["contract"] = from_union([lambda x: to_class(FluffyContract, x), from_none], self.contract)
...
class AppointmentGetAppointmentByShowcaseRequestParams:
    ...
    def __init__(self, business: IndigoBusiness, created: Optional[ParamsCreated], page: float, page_size: float, source: Optional[str]) -> None:
        self.business = business
        self.created = created
        self.page = page
        self.page_size = page_size
...
class AppointmentGetAppointmentsByClientV2RequestParams:
    ...
    def __init__(self, business: IndecentBusiness, client: StickyClient, extra_filters: Optional[FluffyExtraFilters], filter: Optional[FluffyFilter], network: Optional[FluffyNetwork], skip_business_cancelled: Optional[bool]) -> None:
        self.business = business
        self.client = client
        self.extra_filters = extra_filters
        self.filter = filter
...
class AppointmentGetAppointmentsByClientV2Response:
    ...
    def __init__(self, id: float, jsonrpc: str, result: Optional[List[Appointment]], error: Optional[AppointmentGetAppointmentsByClientV2ResponseError]) -> None:
        self.id = id
        self.jsonrpc = jsonrpc
        self.result = result
        self.error = error
...
class HilariousAppointment:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'HilariousAppointment':
        assert isinstance(obj, dict)
        id = from_str(obj.get("id"))
        return HilariousAppointment(id)
...
class OpenAppointmentParams:
    appointment: HilariousAppointment
    business: AmbitiousBusiness

    def __init__(self, appointment: HilariousAppointment, business: AmbitiousBusiness) -> None:
        self.appointment = appointment
        self.business = business

    @staticmethod
    def from_dict(obj: Any) -> 'OpenAppointmentParams':
        assert isinstance(obj, dict)
        appointment = HilariousAppointment.from_dict(obj.get("appointment"))
        business = AmbitiousBusiness.from_dict(obj.get("business"))
        return OpenAppointmentParams(appointment, business)

    def to_dict(self) -> dict:
        result: dict = {}
        result["appointment"] = to_class(HilariousAppointment, self.appointment)
        result["business"] = to_class(AmbitiousBusiness, self.business)
        return result


class AppointmentOpenAppointmentRequest:
    """авторизационные параметры"""
    cred: Optional[Cred]
    """значение числового типа для идентификации запроса на сервере"""
    id: Union[float, str]
    ...
    def __init__(self, cred: Optional[Cred], id: Union[float, str], jsonrpc: str, method: str, params: OpenAppointmentParams) -> None:
        self.cred = cred
        self.id = id
        self.jsonrpc = jsonrpc
        self.method = method
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppointmentOpenAppointmentRequest':
        assert isinstance(obj, dict)
        cred = from_union([Cred.from_dict, from_none], obj.get("cred"))
        id = from_union([from_float, from_str], obj.get("id"))
        jsonrpc = from_str(obj.get("jsonrpc"))
        method = from_str(obj.get("method"))
        params = OpenAppointmentParams.from_dict(obj.get("params"))
        return AppointmentOpenAppointmentRequest(cred, id, jsonrpc, method, params)
    ...
    def to_dict(self) -> dict:
        ...
        result["jsonrpc"] = from_str(self.jsonrpc)
        result["method"] = from_str(self.method)
        result["params"] = to_class(OpenAppointmentParams, self.params)
        return result


class AppointmentOpenAppointmentResponseError:
    """объект, содержащий информацию об ошибке
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppointmentOpenAppointmentResponseError':
        assert isinstance(obj, dict)
        code = from_float(obj.get("code"))
        data = from_union([from_str, lambda x: from_dict(lambda x: x, x), from_none], obj.get("data"))
        message = from_str(obj.get("message"))
        return AppointmentOpenAppointmentResponseError(code, data, message)
...
class AppointmentOpenAppointmentResponse:
    """значение числового типа для идентификации запроса на сервере"""
    id: float
    """версия протокола (2.0)"""
    jsonrpc: str
    ...
    result: Optional[bool]
    """объект, содержащий информацию об ошибке"""
    error: Optional[AppointmentOpenAppointmentResponseError]

    def __init__(self, id: float, jsonrpc: str, result: Optional[bool], error: Optional[AppointmentOpenAppointmentResponseError]) -> None:
        self.id = id
        self.jsonrpc = jsonrpc
        self.result = result
        self.error = error
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppointmentOpenAppointmentResponse':
        assert isinstance(obj, dict)
        id = from_float(obj.get("id"))
        jsonrpc = from_str(obj.get("jsonrpc"))
        result = from_union([from_bool, from_none], obj.get("result"))
        error = from_union([AppointmentOpenAppointmentResponseError.from_dict, from_none], obj.get("error"))
        return AppointmentOpenAppointmentResponse(id, jsonrpc, result, error)
    ...
    def to_dict(self) -> dict:
        ...
        result["jsonrpc"] = from_str(self.jsonrpc)
        result["result"] = from_union([from_bool, from_none], self.result)
        result["error"] = from_union([lambda x: to_class(AppointmentOpenAppointmentResponseError, x), from_none], self.error)
        return result
...
class OpenAppointment:
    ...
    def __init__(self, request: AppointmentOpenAppointmentRequest, response: AppointmentOpenAppointmentResponse) -> None:
        self.request = request
        self.response = response

    @staticmethod
    def from_dict(obj: Any) -> 'OpenAppointment':
        assert isinstance(obj, dict)
        request = AppointmentOpenAppointmentRequest.from_dict(obj.get("request"))
        response = AppointmentOpenAppointmentResponse.from_dict(obj.get("response"))
        return OpenAppointment(request, response)

    def to_dict(self) -> dict:
        result: dict = {}
        result["request"] = to_class(AppointmentOpenAppointmentRequest, self.request)
        result["response"] = to_class(AppointmentOpenAppointmentResponse, self.response)
        return result
...
class AmbitiousAppointment:
    duration: Optional[float]
    price: Optional[PurplePrice]
    start: str

    def __init__(self, duration: Optional[float], price: Optional[PurplePrice], start: str) -> None:
        self.duration = duration
        self.price = price
        self.start = start

    @staticmethod
    def from_dict(obj: Any) -> 'AmbitiousAppointment':
        assert isinstance(obj, dict)
        ...
        return AmbitiousAppointment(duration, price, start)
...
class AppointmentReserve:
    ...
    def __init__(self, appointment: AmbitiousAppointment, business: CunningBusiness, origin_business_id: Optional[str], resource: PurpleResource, source: str, taxonomy: PurpleTaxonomy) -> None:
        self.appointment = appointment
        self.business = business
    ...
    def from_dict(obj: Any) -> 'AppointmentReserve':
        assert isinstance(obj, dict)
        appointment = AmbitiousAppointment.from_dict(obj.get("appointment"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["appointment"] = to_class(AmbitiousAppointment, self.appointment)
...
class CunningAppointment:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'CunningAppointment':
        assert isinstance(obj, dict)
        id = from_str(obj.get("id"))
        return CunningAppointment(id)
...
class StartAppointmentParams:
    appointment: CunningAppointment
    business: MagentaBusiness

    def __init__(self, appointment: CunningAppointment, business: MagentaBusiness) -> None:
        self.appointment = appointment
        self.business = business

    @staticmethod
    def from_dict(obj: Any) -> 'StartAppointmentParams':
        assert isinstance(obj, dict)
        appointment = CunningAppointment.from_dict(obj.get("appointment"))
        business = MagentaBusiness.from_dict(obj.get("business"))
        return StartAppointmentParams(appointment, business)

    def to_dict(self) -> dict:
        result: dict = {}
        result["appointment"] = to_class(CunningAppointment, self.appointment)
        result["business"] = to_class(MagentaBusiness, self.business)
        return result


class AppointmentStartAppointmentRequest:
    """авторизационные параметры"""
    cred: Optional[Cred]
    """значение числового типа для идентификации запроса на сервере"""
    id: Union[float, str]
    ...
    def __init__(self, cred: Optional[Cred], id: Union[float, str], jsonrpc: str, method: str, params: StartAppointmentParams) -> None:
        self.cred = cred
        self.id = id
        self.jsonrpc = jsonrpc
        self.method = method
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppointmentStartAppointmentRequest':
        assert isinstance(obj, dict)
        cred = from_union([Cred.from_dict, from_none], obj.get("cred"))
        id = from_union([from_float, from_str], obj.get("id"))
        jsonrpc = from_str(obj.get("jsonrpc"))
        method = from_str(obj.get("method"))
        params = StartAppointmentParams.from_dict(obj.get("params"))
        return AppointmentStartAppointmentRequest(cred, id, jsonrpc, method, params)
    ...
    def to_dict(self) -> dict:
        ...
        result["jsonrpc"] = from_str(self.jsonrpc)
        result["method"] = from_str(self.method)
        result["params"] = to_class(StartAppointmentParams, self.params)
        return result


class AppointmentStartAppointmentResponseError:
    """объект, содержащий информацию об ошибке
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppointmentStartAppointmentResponseError':
        assert isinstance(obj, dict)
        code = from_float(obj.get("code"))
        data = from_union([from_str, lambda x: from_dict(lambda x: x, x), from_none], obj.get("data"))
        message = from_str(obj.get("message"))
        return AppointmentStartAppointmentResponseError(code, data, message)
...
class AppointmentStartAppointmentResponse:
    """значение числового типа для идентификации запроса на сервере"""
    id: float
    """версия протокола (2.0)"""
    jsonrpc: str
    ...
    result: Optional[bool]
    """объект, содержащий информацию об ошибке"""
    error: Optional[AppointmentStartAppointmentResponseError]

    def __init__(self, id: float, jsonrpc: str, result: Optional[bool], error: Optional[AppointmentStartAppointmentResponseError]) -> None:
        self.id = id
        self.jsonrpc = jsonrpc
        self.result = result
        self.error = error
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppointmentStartAppointmentResponse':
        assert isinstance(obj, dict)
        id = from_float(obj.get("id"))
        jsonrpc = from_str(obj.get("jsonrpc"))
        result = from_union([from_bool, from_none], obj.get("result"))
        error = from_union([AppointmentStartAppointmentResponseError.from_dict, from_none], obj.get("error"))
        return AppointmentStartAppointmentResponse(id, jsonrpc, result, error)
    ...
    def to_dict(self) -> dict:
        ...
        result["jsonrpc"] = from_str(self.jsonrpc)
        result["result"] = from_union([from_bool, from_none], self.result)
        result["error"] = from_union([lambda x: to_class(AppointmentStartAppointmentResponseError, x), from_none], self.error)
        return result
...
class StartAppointment:
    ...
    def __init__(self, request: AppointmentStartAppointmentRequest, response: AppointmentStartAppointmentResponse) -> None:
        self.request = request
        self.response = response

    @staticmethod
    def from_dict(obj: Any) -> 'StartAppointment':
        assert isinstance(obj, dict)
        request = AppointmentStartAppointmentRequest.from_dict(obj.get("request"))
        response = AppointmentStartAppointmentResponse.from_dict(obj.get("response"))
        return StartAppointment(request, response)

    def to_dict(self) -> dict:
        result: dict = {}
        result["request"] = to_class(AppointmentStartAppointmentRequest, self.request)
        result["response"] = to_class(AppointmentStartAppointmentResponse, self.response)
        return result
...
class AppointmentController:
    ...
    open_appointment: Optional[OpenAppointment]
    reserve_appointment: ReserveAppointment
    start_appointment: Optional[StartAppointment]

    def __init__(self, cancel_appointment_by_business: Optional[CancelAppointmentByBusiness], cancel_appointment_by_client: Optional[CancelAppointmentByClient], client_appear: Optional[ClientAppear], client_confirm_appointment: Optional[ClientConfirmAppointment], client_remove_empty_appointment: ClientRemoveEmptyAppointment, finish_appointment: Optional[FinishAppointment], get_appointment_by_filter: Optional[GetAppointmentByFilter], get_appointment_by_showcase: Optional[GetAppointmentByShowcase], get_appointments_by_client_v2: Optional[GetAppointmentsByClientV2], get_appointments_by_user: Optional[GetAppointmentsByUser], open_appointment: Optional[OpenAppointment], reserve_appointment: ReserveAppointment, start_appointment: Optional[StartAppointment]) -> None:
        ...
        self.finish_appointment = finish_appointment
        ...
        self.open_appointment = open_appointment
        self.reserve_appointment = reserve_appointment
        self.start_appointment = start_appointment
    ...
    def from_dict(obj: Any) -> 'AppointmentController':
        ...
        client_appear = from_union([ClientAppear.from_dict, from_none], obj.get("client_appear"))
        ...
        finish_appointment = from_union([FinishAppointment.from_dict, from_none], obj.get("finish_appointment"))
        ...
        open_appointment = from_union([OpenAppointment.from_dict, from_none], obj.get("open_appointment"))
        reserve_appointment = ReserveAppointment.from_dict(obj.get("reserve_appointment"))
        start_appointment = from_union([StartAppointment.from_dict, from_none], obj.get("start_appointment"))
        return AppointmentController(cancel_appointment_by_business, cancel_appointment_by_client, client_appear, client_confirm_appointment, client_remove_empty_appointment, finish_appointment, get_appointment_by_filter, get_appointment_by_showcase, get_appointments_by_client_v2, get_appointments_by_user, open_appointment, reserve_appointment, start_appointment)
    ...
    def to_dict(self) -> dict:
        ...
        result["client_appear"] = from_union([lambda x: to_class(ClientAppear, x), from_none], self.client_appear)
        ...
        result["finish_appointment"] = from_union([lambda x: to_class(FinishAppointment, x), from_none], self.finish_appointment)
        ...
        result["open_appointment"] = from_union([lambda x: to_class(OpenAppointment, x), from_none], self.open_appointment)
        result["reserve_appointment"] = to_class(ReserveAppointment, self.reserve_appointment)
        result["start_appointment"] = from_union([lambda x: to_class(StartAppointment, x), from_none], self.start_appointment)
        return result
...
class BusinessGetNetworkDataRequestParams:
    ...
    def from_dict(obj: Any) -> 'BusinessGetNetworkDataRequestParams':
        ...
        return BusinessGetNetworkDataRequestParams(contract, network_id, resource, taxonomy, with_business_info)
...
class PurpleClientCancellationRestriction:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'PurpleClientCancellationRestriction':
        assert isinstance(obj, dict)
        ...
        return PurpleClientCancellationRestriction(active, disable_in_hours)
...
class PurpleTelemedApplication:
    apple_app_name: Optional[str]
    google_app_name: Optional[str]
    url_app_schema: Optional[str]

    def __init__(self, apple_app_name: Optional[str], google_app_name: Optional[str], url_app_schema: Optional[str]) -> None:
        self.apple_app_name = apple_app_name
        self.google_app_name = google_app_name
        self.url_app_schema = url_app_schema

    @staticmethod
    def from_dict(obj: Any) -> 'PurpleTelemedApplication':
        assert isinstance(obj, dict)
        apple_app_name = from_union([from_str, from_none], obj.get("appleAppName"))
        google_app_name = from_union([from_str, from_none], obj.get("googleAppName"))
        url_app_schema = from_union([from_str, from_none], obj.get("urlAppSchema"))
        return PurpleTelemedApplication(apple_app_name, google_app_name, url_app_schema)

    def to_dict(self) -> dict:
        result: dict = {}
        result["appleAppName"] = from_union([from_str, from_none], self.apple_app_name)
        result["googleAppName"] = from_union([from_str, from_none], self.google_app_name)
        result["urlAppSchema"] = from_union([from_str, from_none], self.url_app_schema)
        return result


class TelemedProvider(Enum):
    DISABLE = "DISABLE"
    MMCONF = "mmconf"
    ZOOM = "zoom"
...
class InfoBackofficeConfiguration:
    ...
    client_cancellation_restriction: Optional[PurpleClientCancellationRestriction]
    ...
    resoure_login_hide_cancelled_appointment: Optional[bool]
    ...
    show_guarantee_letters_screen: Optional[bool]
    ...
    show_partners_contract_screen: Optional[bool]
    ...
    telemed_application: Optional[PurpleTelemedApplication]
    telemed_provider: Optional[TelemedProvider]
    ...
    def __init__(self, adjacent_taxonomies_treshold: Optional[float], allow_hide_service_for_booking: Optional[bool], allow_hide_workers_from_schdeule: Optional[bool], allow_sms_translit: Optional[bool], appointment_future_moving: Optional[bool], block_notification_for_any_available_adjacent_service: Optional[bool], cabinets_enabled: Optional[bool], check_client_overlapping: Optional[bool], client_cancellation_restriction: Optional[PurpleClientCancellationRestriction], custom_online_payment_confirmation_template: Optional[str], default_gt_schedule_day_view: Optional[bool], disable_appointment_client_inline_editor: Optional[bool], edit_app_extra_id: Optional[bool], edit_taxonomy_children: Optional[bool], edit_taxonomy_visit_type: Optional[bool], enable_black_list: Optional[bool], enable_calculate_shedule: Optional[bool], enable_client_card: Optional[bool], enable_client_language: Optional[bool], enable_client_medical_card_report: Optional[bool], enable_custom_online_payment_confirmation: Optional[bool], enable_extended_phone: Optional[bool], enable_extended_records_client_statistics: Optional[bool], enable_invoice: Optional[bool], enable_master_importance: Optional[bool], enable_phone_national_mode: Optional[bool], enable_printing_report_records_screen: Optional[bool], enable_service_or_mode_filter: Optional[bool], enable_service_time_limit: Optional[bool], enable_source_choice: Optional[bool], enable_taxonomy_children_age_check: Optional[bool], enable_telemed: Optional[bool], export_to_excel_removed_clients: Optional[bool], feedback_customer_portal_message: Optional[str], feedback_customer_portal_thank_you_message: Optional[str], feedback_customer_portal_title: Optional[str], feed_back_min_rating: Optional[FeedBackMinRating], fin_id: Optional[str], fin_name: Optional[str], hide_customer_portal_footer: Optional[bool], highlighted_resource: Optional[bool], invoice_condition: Optional[List[AppointmentClientPayment]], invoice_provider: Optional[InvoiceProvider], manual_exception_support: Optional[bool], no_internet_alert: Optional[bool], past_time_edit: Optional[float], payment_provider: Optional[PaymentProvider], readonly_resource_schedule: Optional[bool], resource_surname_first: Optional[bool], resource_timetable_type: Optional[ResourceTimetableType], resoure_login_hide_cancelled_appointment: Optional[bool], revision_version: Optional[float], schdule_week_view_is_default: Optional[bool], schedule_default_workers_limit: Optional[float], schedule_default_workers_limit_day: Optional[float], schedule_default_workers_limit_week: Optional[float], scheduler_week_view_type: Optional[SchedulerWeekViewType], schedule_worker_hours: Optional[bool], show_additional_fields: Optional[bool], show_address: Optional[bool], show_birth_date: Optional[bool], show_client_address: Optional[bool], show_client_appear: Optional[bool], show_client_appear_on_schedule: Optional[bool], show_client_birthday_filter: Optional[bool], show_client_contract_number: Optional[bool], show_client_image: Optional[bool], show_client_payment: Optional[bool], show_created_username: Optional[bool], show_defaulter_blockscreen: Optional[bool], show_delivery_status: Optional[bool], show_department_filter: Optional[bool], show_departments: Optional[bool], show_departments_configuration: Optional[bool], show_email: Optional[bool], show_extra_client_info: Optional[bool], show_fax: Optional[bool], show_fired_worker_appointment_alert: Optional[bool], show_first_available_slot: Optional[bool], show_gap_window: Optional[bool], show_gender: Optional[bool], show_gender_in_records: Optional[bool], show_generatable_reports_screen: Optional[bool], show_guarantee_letters_screen: Optional[bool], show_house_number: Optional[bool], show_israel_city: Optional[bool], show_kupat_holim: Optional[bool], show_leads_screen: Optional[bool], show_manual_changes: Optional[bool], show_partners_contract_screen: Optional[bool], show_passport_id: Optional[bool], show_rooms: Optional[bool], show_season_tickets: Optional[bool], show_taxonomy_children: Optional[bool], show_taxonomy_localization: Optional[bool], show_taxonomy_visit_type: Optional[bool], show_test_record: Optional[bool], show_utm: Optional[bool], show_widget_color_theme: Optional[bool], show_worker_description_in_event: Optional[bool], show_worker_extra_id: Optional[bool], show_worker_status: Optional[bool], skip_appointment_price_update: Optional[bool], skip_cancel_if_client_not_appear: Optional[bool], skip_service_filtering: Optional[bool], split_full_name_xls_export: Optional[bool], state_level_holidays: Optional[List[Dict[str, Any]]], state_level_holidays_not_working: Optional[bool], taxonomy_children_max_age: Optional[float], telemed_application: Optional[PurpleTelemedApplication], telemed_provider: Optional[TelemedProvider], use_additional_durations: Optional[bool], use_adjacent_taxonomies: Optional[bool], use_adjacent_taxonomies_slot_splitting: Optional[bool], use_gt_app_method: Optional[bool], work_week_end: Optional[float], work_week_start: Optional[float]) -> None:
        ...
        self.resoure_login_hide_cancelled_appointment = resoure_login_hide_cancelled_appointment
        ...
        self.show_guarantee_letters_screen = show_guarantee_letters_screen
        ...
        self.show_partners_contract_screen = show_partners_contract_screen
        ...
        self.telemed_application = telemed_application
    ...
    def from_dict(obj: Any) -> 'InfoBackofficeConfiguration':
        ...
        client_cancellation_restriction = from_union([PurpleClientCancellationRestriction.from_dict, from_none], obj.get("clientCancellationRestriction"))
        ...
        resoure_login_hide_cancelled_appointment = from_union([from_bool, from_none], obj.get("resoureLoginHideCancelledAppointment"))
        ...
        show_guarantee_letters_screen = from_union([from_bool, from_none], obj.get("showGuaranteeLettersScreen"))
        ...
        show_partners_contract_screen = from_union([from_bool, from_none], obj.get("showPartnersContractScreen"))
        ...
        telemed_application = from_union([PurpleTelemedApplication.from_dict, from_none], obj.get("telemedApplication"))
        telemed_provider = from_union([TelemedProvider, from_none], obj.get("telemedProvider"))
    ...
    def to_dict(self) -> dict:
        ...
        result["clientCancellationRestriction"] = from_union([lambda x: to_class(PurpleClientCancellationRestriction, x), from_none], self.client_cancellation_restriction)
        ...
        result["resoureLoginHideCancelledAppointment"] = from_union([from_bool, from_none], self.resoure_login_hide_cancelled_appointment)
        ...
        result["showGuaranteeLettersScreen"] = from_union([from_bool, from_none], self.show_guarantee_letters_screen)
        ...
        result["showPartnersContractScreen"] = from_union([from_bool, from_none], self.show_partners_contract_screen)
        ...
        result["telemedApplication"] = from_union([lambda x: to_class(PurpleTelemedApplication, x), from_none], self.telemed_application)
        result["telemedProvider"] = from_union([lambda x: to_enum(TelemedProvider, x), from_none], self.telemed_provider)
...
class FluffyClientCancellationRestriction:
    active: Optional[bool]
    disable_in_hours: Optional[float]
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FluffyClientCancellationRestriction':
        assert isinstance(obj, dict)
        active = from_union([from_bool, from_none], obj.get("active"))
        disable_in_hours = from_union([from_float, from_none], obj.get("disableInHours"))
        return FluffyClientCancellationRestriction(active, disable_in_hours)
...
class InfoBackofficeConfigurationClass:
    client_cancellation_restriction: Optional[FluffyClientCancellationRestriction]
    enable_extended_phone: Optional[bool]
    enable_master_importance: Optional[bool]
    enable_phone_national_mode: Optional[bool]
    resource_timetable_type: Optional[ResourceTimetableType]

    def __init__(self, client_cancellation_restriction: Optional[FluffyClientCancellationRestriction], enable_extended_phone: Optional[bool], enable_master_importance: Optional[bool], enable_phone_national_mode: Optional[bool], resource_timetable_type: Optional[ResourceTimetableType]) -> None:
        self.client_cancellation_restriction = client_cancellation_restriction
        self.enable_extended_phone = enable_extended_phone
        self.enable_master_importance = enable_master_importance
        self.enable_phone_national_mode = enable_phone_national_mode
    ...
    def from_dict(obj: Any) -> 'InfoBackofficeConfigurationClass':
        assert isinstance(obj, dict)
        client_cancellation_restriction = from_union([FluffyClientCancellationRestriction.from_dict, from_none], obj.get("clientCancellationRestriction"))
        enable_extended_phone = from_union([from_bool, from_none], obj.get("enableExtendedPhone"))
        enable_master_importance = from_union([from_bool, from_none], obj.get("enableMasterImportance"))
        enable_phone_national_mode = from_union([from_bool, from_none], obj.get("enablePhoneNationalMode"))
        resource_timetable_type = from_union([ResourceTimetableType, from_none], obj.get("resourceTimetableType"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["clientCancellationRestriction"] = from_union([lambda x: to_class(FluffyClientCancellationRestriction, x), from_none], self.client_cancellation_restriction)
        result["enableExtendedPhone"] = from_union([from_bool, from_none], self.enable_extended_phone)
        result["enableMasterImportance"] = from_union([from_bool, from_none], self.enable_master_importance)
        result["enablePhoneNationalMode"] = from_union([from_bool, from_none], self.enable_phone_national_mode)
        result["resourceTimetableType"] = from_union([lambda x: to_enum(ResourceTimetableType, x), from_none], self.resource_timetable_type)
...
class Resource:
    ...
    color: Optional[str]
    degree: Optional[str]
    deny_widget_booking: Optional[bool]
    ...
    def __init__(self, additional_extra_id: Optional[List[str]], bad_icon_resolution: Optional[bool], capacity: float, color: Optional[str], degree: Optional[str], deny_widget_booking: Optional[bool], department_id: Optional[str], description: Optional[str], display_in_schedule: Optional[bool], display_in_widget: bool, email: Optional[str], email_enabled: Optional[bool], even_odd_timetable: EvenOddTimetable, exceptions: Optional[List[Any]], experience: Optional[datetime], extra_description: Optional[str], extra_id: Optional[str], extra_link: Optional[str], extra_media_id: Optional[str], icon_url: Optional[str], id: str, image: Optional[str], last_su: Optional[datetime], level: float, loaned: bool, loaned_from: Optional[str], loaned_to: Optional[str], location: ResourceLocation, manual_changes: bool, middle_name: Optional[str], name: str, nickname: Optional[str], order: Optional[float], order_weight: Union[float, None, str], origin_general_info: Optional[Info], origin_business_id: Optional[str], origin_taxonomies: Optional[List[str]], perk: Optional[str], phone: Optional[List[FaxElement]], profession: Optional[str], profile: Optional[ИнформацияОПрофилеРаботника], rating: Optional[float], readonly_taxonomies: Optional[List[str]], revision_version: float, schedule_is_empty: Optional[bool], site_id: Optional[str], sms_enabled: Optional[bool], status: Optional[ResourceStatus], surname: str, taxonomies: List[str], taxonomy_children: List[ResourceTaxonomyChildren], taxonomy_levels: List[ResourceTaxonomyLevel], telemed_data: Optional[ResourceTelemedData], telemed_worker: Optional[bool], timetable: Timetable, user_data: Optional[Dict[str, Any]], work_place: Optional[str]) -> None:
        ...
        self.telemed_data = telemed_data
        self.telemed_worker = telemed_worker
        self.timetable = timetable
    ...
    def from_dict(obj: Any) -> 'Resource':
        ...
        color = from_union([from_str, from_none], obj.get("color"))
        degree = from_union([from_str, from_none], obj.get("degree"))
        deny_widget_booking = from_union([from_bool, from_none], obj.get("denyWidgetBooking"))
        ...
        telemed_worker = from_union([from_bool, from_none], obj.get("telemedWorker"))
        ...
        return Resource(additional_extra_id, bad_icon_resolution, capacity, color, degree, deny_widget_booking, department_id, description, display_in_schedule, display_in_widget, email, email_enabled, even_odd_timetable, exceptions, experience, extra_description, extra_id, extra_link, extra_media_id, icon_url, id, image, last_su, level, loaned, loaned_from, loaned_to, location, manual_changes, middle_name, name, nickname, order, order_weight, origin_general_info, origin_business_id, origin_taxonomies, perk, phone, profession, profile, rating, readonly_taxonomies, revision_version, schedule_is_empty, site_id, sms_enabled, status, surname, taxonomies, taxonomy_children, taxonomy_levels, telemed_data, telemed_worker, timetable, user_data, work_place)
    ...
    def to_dict(self) -> dict:
        ...
        result["color"] = from_union([from_str, from_none], self.color)
        result["degree"] = from_union([from_str, from_none], self.degree)
        result["denyWidgetBooking"] = from_union([from_bool, from_none], self.deny_widget_booking)
        ...
        result["telemedWorker"] = from_union([from_bool, from_none], self.telemed_worker)
...
class DiscountSlot:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'DiscountSlot':
        assert isinstance(obj, dict)
        time = from_union([TimeFrame.from_dict, from_none], obj.get("time"))
        return DiscountSlot(time)
...
class Discount:
    ...
    slots: Optional[List[DiscountSlot]]
    start: Optional[datetime]
    unlim_weekly_repeat: Optional[bool]
    weekly_repeat: Optional[float]

    def __init__(self, active: Optional[bool], days: Optional[List[Day]], repeats: Optional[Repeats], slots: Optional[List[DiscountSlot]], start: Optional[datetime], unlim_weekly_repeat: Optional[bool], weekly_repeat: Optional[float]) -> None:
        self.active = active
        self.days = days
    ...
    def from_dict(obj: Any) -> 'Discount':
        ...
        slots = from_union([lambda x: from_list(DiscountSlot.from_dict, x), from_none], obj.get("slots"))
        start = from_union([from_datetime, from_none], obj.get("start"))
        ...
        return Discount(active, days, repeats, slots, start, unlim_weekly_repeat, weekly_repeat)
    ...
    def to_dict(self) -> dict:
        ...
        result["slots"] = from_union([lambda x: from_list(lambda x: to_class(DiscountSlot, x), x), from_none], self.slots)
        result["start"] = from_union([lambda x: x.isoformat(), from_none], self.start)
...
class FluffyPrice:
    ...
    def from_dict(obj: Any) -> 'FluffyPrice':
        ...
        return FluffyPrice(amount, currency, stock_amount, type)
...
class InfoWidgetConfiguration:
    ...
    crac_build_days: Optional[float]
    ...
    revision_version: Optional[float]
    service_unavailability_text: Optional[str]
    ...
    sort_workers: Optional[Dict[str, Any]]
    sort_workers_by_name: Optional[bool]
    ...
    def __init__(self, additional_name: Optional[str], alignment_taxonomy_slots: Optional[bool], allow_auto_select: Optional[bool], allow_book_visitor: Optional[bool], allow_skip_time_check: Optional[bool], analytics_google: Optional[PurpleAnalyticsGoogle], analytics_yandex: Optional[PurpleAnalyticsYandex], appointment_confirmation_text: Optional[str], appointment_confirmation_title: Optional[str], ask_client_birthday: Optional[bool], ask_client_gender: Optional[bool], ask_client_passport_id: Optional[bool], bookable_date_ranges: Optional[PurpleBookableDateRanges], bookable_months_count: Optional[float], calendar_mode: Optional[bool], calendar_mode_hide_time: Optional[bool], client_blocking_settings: Optional[PurpleClientBlockingSettings], client_comment_title: Optional[str], crac_build_days: Optional[float], crac_server: Optional[CracServer], crac_slot_size: Optional[float], crunchv2: Optional[bool], day_off_label: Optional[str], days_forward: Optional[float], day_unavailable_label: Optional[str], default_service_img_url: Optional[str], default_worker_img_url: Optional[str], deny_same_time_records: Optional[bool], disabled_taxonomies_text: Optional[str], disable_mobile_widget: Optional[bool], disable_widget: Optional[bool], disable_widget_message: Optional[str], discounted_price_rounding: Optional[PurpleDiscountedPriceRounding], display_slot_size: Optional[float], dont_require_email: Optional[bool], email_is_mandatory: Optional[bool], enable_override_footer: Optional[bool], enable_warning_contact_data: Optional[bool], extra_visitors: Optional[bool], filter_non_insurance_schedule: Optional[bool], hide_any_worker_booking: Optional[bool], hide_call_button: Optional[bool], hide_empty_days: Optional[bool], hide_g_booking_logo: Optional[bool], hide_gray_slots: Optional[bool], hide_new_appointment_button: Optional[bool], hide_prices: Optional[bool], hide_social_networks_authentication: Optional[bool], insurance_client_support_phone: Optional[List[FaxElement]], max_service_booking: Optional[float], max_timeslot_booking: Optional[float], middle_name_support: Optional[bool], most_free_enable: Optional[bool], multi_service_booking: Optional[bool], multi_timeslot_booking: Optional[bool], multi_timeslot_booking_all_days: Optional[bool], new_widget_theme: Optional[Dict[str, Any]], no_default_images: Optional[bool], override_footer: Optional[str], payment: Optional[Payment], payment_provider: Optional[PaymentProvider], require_agreement: Optional[bool], require_agreement_link: Optional[str], revision_version: Optional[float], service_unavailability_text: Optional[str], short_link: Optional[str], show_all_workers: Optional[bool], show_client_address: Optional[bool], show_client_comment: Optional[bool], show_disabled_taxonomies: Optional[bool], show_drink_question: Optional[bool], show_map: Optional[bool], show_start_text: Optional[bool], show_surname_first: Optional[bool], show_talk_question: Optional[bool], show_taxonomy_confirmation_alert: Optional[bool], skip_authentication: Optional[bool], skip_days_forward: Optional[bool], skip_mobile_map: Optional[bool], skip_service_duration_alignment: Optional[bool], skip_service_selection: Optional[bool], skip_time_selection: Optional[bool], skip_time_selection_service_i_ds: Optional[List[str]], skip_worker_selected_service_i_ds: Optional[List[str]], skip_worker_services_selection: Optional[bool], social_network_image: Optional[str], social_sharing: Optional[PurpleSocialSharing], sort_by_most_free: Optional[bool], sort_workers: Optional[Dict[str, Any]], sort_workers_by_name: Optional[bool], sort_workers_by_workload: Optional[bool], split_insurance_client: Optional[bool], split_name: Optional[bool], start_text_button: Optional[str], start_text_message: Optional[str], strict_slot_cutting: Optional[bool], tentative_ttl: Optional[float], theme: Optional[str], toggle_reminder: Optional[bool], use_appointment_reminder: Optional[bool], use_business_schedule_for_unavailable_label: Optional[bool], use_clusters_map: Optional[bool], use_coupon: Optional[bool], use_crac: Optional[bool], use_default_service_img: Optional[bool], use_default_worker_img: Optional[bool], use_direct_schedule_read: Optional[UseDirectScheduleRead], use_insurance_guarantee_letter: Optional[bool], use_insurance_select: Optional[bool], use_med_auth: Optional[bool], use_middle_name: Optional[bool], use_new_reserve_api: Optional[bool], use_resource_page_loading: Optional[bool], use_sort_by_name: Optional[bool], warning_contact_data_text: Optional[str], widget_use_crac: Optional[bool], without_workers: Optional[bool], worker_unavailability_text: Optional[str], worker_widget_unavailability_text: Optional[str], worker_name_reverse: Optional[bool]) -> None:
        ...
        self.crac_build_days = crac_build_days
        ...
        self.revision_version = revision_version
        self.service_unavailability_text = service_unavailability_text
        ...
        self.sort_workers = sort_workers
        self.sort_workers_by_name = sort_workers_by_name
        ...
        self.worker_widget_unavailability_text = worker_widget_unavailability_text
    ...
    def from_dict(obj: Any) -> 'InfoWidgetConfiguration':
        ...
        crac_build_days = from_union([from_float, from_none], obj.get("cracBuildDays"))
        ...
        revision_version = from_union([from_float, from_none], obj.get("revisionVersion"))
        service_unavailability_text = from_union([from_str, from_none], obj.get("service_unavailability_text"))
        ...
        sort_workers = from_union([lambda x: from_dict(lambda x: x, x), from_none], obj.get("sortWorkers"))
        sort_workers_by_name = from_union([from_bool, from_none], obj.get("sortWorkersByName"))
    ...
    def to_dict(self) -> dict:
        ...
        result["cracBuildDays"] = from_union([to_float, from_none], self.crac_build_days)
        ...
        result["revisionVersion"] = from_union([to_float, from_none], self.revision_version)
        result["service_unavailability_text"] = from_union([from_str, from_none], self.service_unavailability_text)
        ...
        result["sortWorkers"] = from_union([lambda x: from_dict(lambda x: x, x), from_none], self.sort_workers)
        result["sortWorkersByName"] = from_union([from_bool, from_none], self.sort_workers_by_name)
        ...
        result["worker_widget_unavailability_text"] = from_union([from_str, from_none], self.worker_widget_unavailability_text)
...
class ResultIntegrationData:
    ehr: Optional[Ehr]

    def __init__(self, ehr: Optional[Ehr]) -> None:
        self.ehr = ehr

    @staticmethod
    def from_dict(obj: Any) -> 'ResultIntegrationData':
        assert isinstance(obj, dict)
        ehr = from_union([Ehr.from_dict, from_none], obj.get("ehr"))
        return ResultIntegrationData(ehr)

    def to_dict(self) -> dict:
        result: dict = {}
        result["ehr"] = from_union([lambda x: to_class(Ehr, x), from_none], self.ehr)
        return result


class NetworkClientBlockingSettings:
    appointment_client_block: Optional[bool]
    appointment_client_block_days: Optional[float]
    appointment_client_block_text: Optional[str]
    block_if_future_record_exists: Optional[bool]
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'NetworkClientBlockingSettings':
        assert isinstance(obj, dict)
        appointment_client_block = from_union([from_bool, from_none], obj.get("appointmentClientBlock"))
        appointment_client_block_days = from_union([from_float, from_none], obj.get("appointmentClientBlockDays"))
        appointment_client_block_text = from_union([from_str, from_none], obj.get("appointmentClientBlockText"))
        ...
        block_repeated_records_range = from_union([from_float, from_none], obj.get("blockRepeatedRecordsRange"))
        block_repeated_records_text = from_union([from_str, from_none], obj.get("blockRepeatedRecordsText"))
        return NetworkClientBlockingSettings(appointment_client_block, appointment_client_block_days, appointment_client_block_text, block_if_future_record_exists, block_repeated_records_count, block_repeated_records_range, block_repeated_records_text)
...
class BusinessGetNetworkDataResponseResult:
    ...
    integration_data: Optional[ResultIntegrationData]
    network_client_blocking_settings: Optional[NetworkClientBlockingSettings]
    network_id: str
    ...
    def __init__(self, business_configuration: Dict[str, Any], businesses: List[BusinessRefInNetwork], client_vip_phones: List[str], grant_groups: List[Dict[str, Any]], integration_data: Optional[ResultIntegrationData], network_client_blocking_settings: Optional[NetworkClientBlockingSettings], network_id: str, network_info: Dict[str, Any], network_name: Optional[str], network_widget_configuration: List[NetworkWidgetConfiguration]) -> None:
        self.business_configuration = business_configuration
        self.businesses = businesses
        self.client_vip_phones = client_vip_phones
        self.grant_groups = grant_groups
        self.integration_data = integration_data
        self.network_client_blocking_settings = network_client_blocking_settings
        self.network_id = network_id
    ...
    def from_dict(obj: Any) -> 'BusinessGetNetworkDataResponseResult':
        ...
        integration_data = from_union([ResultIntegrationData.from_dict, from_none], obj.get("integrationData"))
        network_client_blocking_settings = from_union([NetworkClientBlockingSettings.from_dict, from_none], obj.get("networkClientBlockingSettings"))
        ...
        return BusinessGetNetworkDataResponseResult(business_configuration, businesses, client_vip_phones, grant_groups, integration_data, network_client_blocking_settings, network_id, network_info, network_name, network_widget_configuration)
    ...
    def to_dict(self) -> dict:
        ...
        result["integrationData"] = from_union([lambda x: to_class(ResultIntegrationData, x), from_none], self.integration_data)
        result["networkClientBlockingSettings"] = from_union([lambda x: to_class(NetworkClientBlockingSettings, x), from_none], self.network_client_blocking_settings)
...
class TentacledClientCancellationRestriction:
    active: Optional[bool]
    disable_in_hours: Optional[float]
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'TentacledClientCancellationRestriction':
        assert isinstance(obj, dict)
        active = from_union([from_bool, from_none], obj.get("active"))
        disable_in_hours = from_union([from_float, from_none], obj.get("disableInHours"))
        return TentacledClientCancellationRestriction(active, disable_in_hours)
...
class FluffyTelemedApplication:
    apple_app_name: Optional[str]
    google_app_name: Optional[str]
    url_app_schema: Optional[str]
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FluffyTelemedApplication':
        assert isinstance(obj, dict)
        apple_app_name = from_union([from_str, from_none], obj.get("appleAppName"))
        google_app_name = from_union([from_str, from_none], obj.get("googleAppName"))
        url_app_schema = from_union([from_str, from_none], obj.get("urlAppSchema"))
        return FluffyTelemedApplication(apple_app_name, google_app_name, url_app_schema)
...
class BusinessBackofficeConfiguration:
    ...
    cabinets_enabled: Optional[bool]
    check_client_overlapping: Optional[bool]
    client_cancellation_restriction: Optional[TentacledClientCancellationRestriction]
    custom_online_payment_confirmation_template: Optional[str]
    default_gt_schedule_day_view: Optional[bool]
    disable_appointment_client_inline_editor: Optional[bool]
    edit_app_extra_id: Optional[bool]
    ...
    state_level_holidays_not_working: Optional[bool]
    taxonomy_children_max_age: Optional[float]
    telemed_application: Optional[FluffyTelemedApplication]
    telemed_provider: Optional[TelemedProvider]
    use_additional_durations: Optional[bool]
    use_adjacent_taxonomies: Optional[bool]
    use_adjacent_taxonomies_slot_splitting: Optional[bool]
    ...
    def from_dict(obj: Any) -> 'BusinessBackofficeConfiguration':
        ...
        cabinets_enabled = from_union([from_bool, from_none], obj.get("cabinetsEnabled"))
        check_client_overlapping = from_union([from_bool, from_none], obj.get("checkClientOverlapping"))
        client_cancellation_restriction = from_union([TentacledClientCancellationRestriction.from_dict, from_none], obj.get("clientCancellationRestriction"))
        custom_online_payment_confirmation_template = from_union([from_str, from_none], obj.get("customOnlinePaymentConfirmationTemplate"))
        default_gt_schedule_day_view = from_union([from_bool, from_none], obj.get("defaultGTScheduleDayView"))
        disable_appointment_client_inline_editor = from_union([from_bool, from_none], obj.get("disableAppointmentClientInlineEditor"))
        edit_app_extra_id = from_union([from_bool, from_none], obj.get("editAppExtraId"))
        ...
        state_level_holidays_not_working = from_union([from_bool, from_none], obj.get("stateLevelHolidaysNotWorking"))
        taxonomy_children_max_age = from_union([from_float, from_none], obj.get("taxonomyChildrenMaxAge"))
        telemed_application = from_union([FluffyTelemedApplication.from_dict, from_none], obj.get("telemedApplication"))
        telemed_provider = from_union([TelemedProvider, from_none], obj.get("telemedProvider"))
        use_additional_durations = from_union([from_bool, from_none], obj.get("useAdditionalDurations"))
        use_adjacent_taxonomies = from_union([from_bool, from_none], obj.get("useAdjacentTaxonomies"))
        use_adjacent_taxonomies_slot_splitting = from_union([from_bool, from_none], obj.get("useAdjacentTaxonomiesSlotSplitting"))
    ...
    def to_dict(self) -> dict:
        ...
        result["cabinetsEnabled"] = from_union([from_bool, from_none], self.cabinets_enabled)
        result["checkClientOverlapping"] = from_union([from_bool, from_none], self.check_client_overlapping)
        result["clientCancellationRestriction"] = from_union([lambda x: to_class(TentacledClientCancellationRestriction, x), from_none], self.client_cancellation_restriction)
        result["customOnlinePaymentConfirmationTemplate"] = from_union([from_str, from_none], self.custom_online_payment_confirmation_template)
        result["defaultGTScheduleDayView"] = from_union([from_bool, from_none], self.default_gt_schedule_day_view)
        result["disableAppointmentClientInlineEditor"] = from_union([from_bool, from_none], self.disable_appointment_client_inline_editor)
        result["editAppExtraId"] = from_union([from_bool, from_none], self.edit_app_extra_id)
        ...
        result["stateLevelHolidaysNotWorking"] = from_union([from_bool, from_none], self.state_level_holidays_not_working)
        result["taxonomyChildrenMaxAge"] = from_union([to_float, from_none], self.taxonomy_children_max_age)
        result["telemedApplication"] = from_union([lambda x: to_class(FluffyTelemedApplication, x), from_none], self.telemed_application)
        result["telemedProvider"] = from_union([lambda x: to_enum(TelemedProvider, x), from_none], self.telemed_provider)
        result["useAdditionalDurations"] = from_union([from_bool, from_none], self.use_additional_durations)
        result["useAdjacentTaxonomies"] = from_union([from_bool, from_none], self.use_adjacent_taxonomies)
        result["useAdjacentTaxonomiesSlotSplitting"] = from_union([from_bool, from_none], self.use_adjacent_taxonomies_slot_splitting)
...
class StickyClientCancellationRestriction:
    active: Optional[bool]
    disable_in_hours: Optional[float]
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'StickyClientCancellationRestriction':
        assert isinstance(obj, dict)
        active = from_union([from_bool, from_none], obj.get("active"))
        disable_in_hours = from_union([from_float, from_none], obj.get("disableInHours"))
        return StickyClientCancellationRestriction(active, disable_in_hours)
...
class BusinessBackofficeConfigurationClass:
    client_cancellation_restriction: Optional[StickyClientCancellationRestriction]
    enable_extended_phone: Optional[bool]
    enable_master_importance: Optional[bool]
    enable_phone_national_mode: Optional[bool]
    resource_timetable_type: Optional[ResourceTimetableType]

    def __init__(self, client_cancellation_restriction: Optional[StickyClientCancellationRestriction], enable_extended_phone: Optional[bool], enable_master_importance: Optional[bool], enable_phone_national_mode: Optional[bool], resource_timetable_type: Optional[ResourceTimetableType]) -> None:
        self.client_cancellation_restriction = client_cancellation_restriction
        self.enable_extended_phone = enable_extended_phone
        self.enable_master_importance = enable_master_importance
        self.enable_phone_national_mode = enable_phone_national_mode
    ...
    def from_dict(obj: Any) -> 'BusinessBackofficeConfigurationClass':
        assert isinstance(obj, dict)
        client_cancellation_restriction = from_union([StickyClientCancellationRestriction.from_dict, from_none], obj.get("clientCancellationRestriction"))
        enable_extended_phone = from_union([from_bool, from_none], obj.get("enableExtendedPhone"))
        enable_master_importance = from_union([from_bool, from_none], obj.get("enableMasterImportance"))
        enable_phone_national_mode = from_union([from_bool, from_none], obj.get("enablePhoneNationalMode"))
        resource_timetable_type = from_union([ResourceTimetableType, from_none], obj.get("resourceTimetableType"))
        return BusinessBackofficeConfigurationClass(client_cancellation_restriction, enable_extended_phone, enable_master_importance, enable_phone_national_mode, resource_timetable_type)

    def to_dict(self) -> dict:
        result: dict = {}
        result["clientCancellationRestriction"] = from_union([lambda x: to_class(StickyClientCancellationRestriction, x), from_none], self.client_cancellation_restriction)
        result["enableExtendedPhone"] = from_union([from_bool, from_none], self.enable_extended_phone)
        result["enableMasterImportance"] = from_union([from_bool, from_none], self.enable_master_importance)
        result["enablePhoneNationalMode"] = from_union([from_bool, from_none], self.enable_phone_national_mode)
        result["resourceTimetableType"] = from_union([lambda x: to_enum(ResourceTimetableType, x), from_none], self.resource_timetable_type)
...
class ClientFavResource:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ClientFavResource':
        assert isinstance(obj, dict)
        business_id = from_float(obj.get("businessID"))
        network_id = from_str(obj.get("networkID"))
        resource_id = from_str(obj.get("resourceID"))
        return ClientFavResource(business_id, network_id, resource_id)
...
class ClientIntegrationData:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ClientIntegrationData':
        assert isinstance(obj, dict)
        transaction_id = from_union([from_str, from_none], obj.get("transactionID"))
        return ClientIntegrationData(transaction_id)
...
class ClientClass:
    ...
    extra_id: Optional[str]
    fav_resources: Optional[List[ClientFavResource]]
    fax: Optional[str]
    ...
    integration_data: Optional[ClientIntegrationData]
    ...
    def from_dict(obj: Any) -> 'ClientClass':
        ...
        extra_id = from_union([from_str, from_none], obj.get("extraID"))
        fav_resources = from_union([lambda x: from_list(ClientFavResource.from_dict, x), from_none], obj.get("favResources"))
        ...
        integration_data = from_union([ClientIntegrationData.from_dict, from_none], obj.get("integrationData"))
    ...
    def to_dict(self) -> dict:
        ...
        result["extraID"] = from_union([from_str, from_none], self.extra_id)
        result["favResources"] = from_union([lambda x: from_list(lambda x: to_class(ClientFavResource, x), x), from_none], self.fav_resources)
        ...
        result["integrationData"] = from_union([lambda x: to_class(ClientIntegrationData, x), from_none], self.integration_data)
...
class ClientAddClientRequestParams:
    ...
    def __init__(self, business: MischievousBusiness, client: ClientClass, profile: Optional[ParamsProfile], skip_email_check: Optional[bool], skip_profile_update: Optional[bool]) -> None:
        self.business = business
        self.client = client
        self.profile = profile
...
class ClientAddClientResponseResult:
    ...
    def __init__(self, business: BraggadociousBusiness, client: ClientClass, documents: Optional[List[str]], profile: Optional[PurpleProfile], source: Optional[Source]) -> None:
        self.business = business
        self.client = client
...
class ClientFindOfCreateClientResponseResult:
    business: Optional[Business2]
    client: ClientClass
    documents: Optional[List[Any]]
    profile: Optional[FluffyProfile]

    def __init__(self, business: Optional[Business2], client: ClientClass, documents: Optional[List[Any]], profile: Optional[FluffyProfile]) -> None:
        self.business = business
        self.client = client
        self.documents = documents
        self.profile = profile
    ...
    def from_dict(obj: Any) -> 'ClientFindOfCreateClientResponseResult':
        assert isinstance(obj, dict)
        business = from_union([Business2.from_dict, from_none], obj.get("business"))
        client = ClientClass.from_dict(obj.get("client"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["business"] = from_union([lambda x: to_class(Business2, x), from_none], self.business)
        result["client"] = to_class(ClientClass, self.client)
...
class ClientUpdateClientRequestParams:
    """параметры запроса"""
    business: Optional[Business3]
    client: ClientClass
    network: Optional[IndigoNetwork]

    def __init__(self, business: Optional[Business3], client: ClientClass, network: Optional[IndigoNetwork]) -> None:
        self.business = business
        self.client = client
        self.network = network
    ...
    def from_dict(obj: Any) -> 'ClientUpdateClientRequestParams':
        assert isinstance(obj, dict)
        business = from_union([Business3.from_dict, from_none], obj.get("business"))
        client = ClientClass.from_dict(obj.get("client"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["business"] = from_union([lambda x: to_class(Business3, x), from_none], self.business)
        result["client"] = to_class(ClientClass, self.client)
...
class PurpleExtraField:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'PurpleExtraField':
        assert isinstance(obj, dict)
        field_id = from_str(obj.get("fieldID"))
        field_name = from_str(obj.get("fieldName"))
        value = from_union([from_none, from_float, from_bool, from_str, lambda x: from_dict(lambda x: x, x)], obj.get("value"))
        return PurpleExtraField(field_id, field_name, value)
...
class PurpleFavResource:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'PurpleFavResource':
        assert isinstance(obj, dict)
        business_id = from_float(obj.get("businessID"))
        network_id = from_str(obj.get("networkID"))
        resource_id = from_str(obj.get("resourceID"))
        return PurpleFavResource(business_id, network_id, resource_id)
...
class IndigoClient:
    ...
    description: Optional[str]
    email: Optional[List[str]]
    extra_fields: Optional[List[PurpleExtraField]]
    fav_resources: Optional[List[PurpleFavResource]]
    icon_url: Optional[str]
    id: Optional[str]
    insurance_number: Optional[str]
    language: Optional[LanguageList]
    ...
    def __init__(self, address: Optional[str], birthday: Union[Dict[str, Any], None, str], description: Optional[str], email: Optional[List[str]], extra_fields: Optional[List[PurpleExtraField]], fav_resources: Optional[List[PurpleFavResource]], icon_url: Optional[str], id: Optional[str], insurance_number: Optional[str], language: Optional[LanguageList], middle_name: Optional[str], name: str, passport_id: Optional[str], sex: Optional[Sex], surname: str) -> None:
        self.address = address
        self.birthday = birthday
        self.description = description
        self.email = email
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'IndigoClient':
        assert isinstance(obj, dict)
        address = from_union([from_str, from_none], obj.get("address"))
        birthday = from_union([from_str, lambda x: from_dict(lambda x: x, x), from_none], obj.get("birthday"))
        description = from_union([from_str, from_none], obj.get("description"))
        email = from_union([lambda x: from_list(from_str, x), from_none], obj.get("email"))
        extra_fields = from_union([lambda x: from_list(PurpleExtraField.from_dict, x), from_none], obj.get("extraFields"))
        fav_resources = from_union([lambda x: from_list(PurpleFavResource.from_dict, x), from_none], obj.get("favResources"))
        icon_url = from_union([from_str, from_none], obj.get("icon_url"))
        id = from_union([from_str, from_none], obj.get("id"))
        insurance_number = from_union([from_str, from_none], obj.get("insuranceNumber"))
        language = from_union([LanguageList, from_none], obj.get("language"))
        ...
        sex = from_union([Sex, from_none], obj.get("sex"))
        surname = from_str(obj.get("surname"))
        return IndigoClient(address, birthday, description, email, extra_fields, fav_resources, icon_url, id, insurance_number, language, middle_name, name, passport_id, sex, surname)
    ...
    def to_dict(self) -> dict:
        ...
        result["description"] = from_union([from_str, from_none], self.description)
        result["email"] = from_union([lambda x: from_list(from_str, x), from_none], self.email)
        result["extraFields"] = from_union([lambda x: from_list(lambda x: to_class(PurpleExtraField, x), x), from_none], self.extra_fields)
        result["favResources"] = from_union([lambda x: from_list(lambda x: to_class(PurpleFavResource, x), x), from_none], self.fav_resources)
        result["icon_url"] = from_union([from_str, from_none], self.icon_url)
        result["id"] = from_union([from_str, from_none], self.id)
        result["insuranceNumber"] = from_union([from_str, from_none], self.insurance_number)
        result["language"] = from_union([lambda x: to_enum(LanguageList, x), from_none], self.language)
...
class IndecentNetwork:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'IndecentNetwork':
        assert isinstance(obj, dict)
        id = from_union([from_float, from_str, from_none], obj.get("id"))
        return IndecentNetwork(id)
...
class ClientUpdateClientInfoRequestParams:
    """параметры запроса"""
    business: Optional[Business4]
    client: IndigoClient
    network: Optional[IndecentNetwork]

    def __init__(self, business: Optional[Business4], client: IndigoClient, network: Optional[IndecentNetwork]) -> None:
        self.business = business
        self.client = client
        self.network = network

    @staticmethod
    def from_dict(obj: Any) -> 'ClientUpdateClientInfoRequestParams':
        assert isinstance(obj, dict)
        business = from_union([Business4.from_dict, from_none], obj.get("business"))
        client = IndigoClient.from_dict(obj.get("client"))
        network = from_union([IndecentNetwork.from_dict, from_none], obj.get("network"))
        return ClientUpdateClientInfoRequestParams(business, client, network)

    def to_dict(self) -> dict:
        result: dict = {}
        result["business"] = from_union([lambda x: to_class(Business4, x), from_none], self.business)
        result["client"] = to_class(IndigoClient, self.client)
        result["network"] = from_union([lambda x: to_class(IndecentNetwork, x), from_none], self.network)
        return result


class ClientUpdateClientInfoRequest:
    """авторизационные параметры"""
    cred: Optional[Cred]
    """значение числового типа для идентификации запроса на сервере"""
    id: Union[float, str]
    ...
    def __init__(self, cred: Optional[Cred], id: Union[float, str], jsonrpc: str, method: str, params: ClientUpdateClientInfoRequestParams) -> None:
        self.cred = cred
        self.id = id
        self.jsonrpc = jsonrpc
        self.method = method
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ClientUpdateClientInfoRequest':
        assert isinstance(obj, dict)
        cred = from_union([Cred.from_dict, from_none], obj.get("cred"))
        id = from_union([from_float, from_str], obj.get("id"))
        jsonrpc = from_str(obj.get("jsonrpc"))
        method = from_str(obj.get("method"))
        params = ClientUpdateClientInfoRequestParams.from_dict(obj.get("params"))
        return ClientUpdateClientInfoRequest(cred, id, jsonrpc, method, params)
    ...
    def to_dict(self) -> dict:
        ...
        result["jsonrpc"] = from_str(self.jsonrpc)
        result["method"] = from_str(self.method)
        result["params"] = to_class(ClientUpdateClientInfoRequestParams, self.params)
        return result


class ClientUpdateClientInfoResponseError:
    """объект, содержащий информацию об ошибке
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ClientUpdateClientInfoResponseError':
        assert isinstance(obj, dict)
        code = from_float(obj.get("code"))
        data = from_union([from_str, lambda x: from_dict(lambda x: x, x), from_none], obj.get("data"))
        message = from_str(obj.get("message"))
        return ClientUpdateClientInfoResponseError(code, data, message)
...
class ClientUpdateClientInfoResponseResult:
    added_document: Optional[Dict[str, Any]]
    success: bool
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ClientUpdateClientInfoResponseResult':
        assert isinstance(obj, dict)
        added_document = from_union([lambda x: from_dict(lambda x: x, x), from_none], obj.get("added_document"))
        success = from_bool(obj.get("success"))
        return ClientUpdateClientInfoResponseResult(added_document, success)
...
class ClientUpdateClientInfoResponse:
    result: Optional[ClientUpdateClientInfoResponseResult]
    """объект, содержащий информацию об ошибке"""
    error: Optional[ClientUpdateClientInfoResponseError]
    """значение числового типа для идентификации запроса на сервере"""
    id: Optional[float]
    """версия протокола (2.0)"""
    jsonrpc: Optional[str]

    def __init__(self, result: Optional[ClientUpdateClientInfoResponseResult], error: Optional[ClientUpdateClientInfoResponseError], id: Optional[float], jsonrpc: Optional[str]) -> None:
        self.result = result
        self.error = error
        self.id = id
        self.jsonrpc = jsonrpc
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ClientUpdateClientInfoResponse':
        assert isinstance(obj, dict)
        result = from_union([ClientUpdateClientInfoResponseResult.from_dict, from_none], obj.get("result"))
        error = from_union([ClientUpdateClientInfoResponseError.from_dict, from_none], obj.get("error"))
        id = from_union([from_float, from_none], obj.get("id"))
        jsonrpc = from_union([from_str, from_none], obj.get("jsonrpc"))
        return ClientUpdateClientInfoResponse(result, error, id, jsonrpc)

    def to_dict(self) -> dict:
        result: dict = {}
        result["result"] = from_union([lambda x: to_class(ClientUpdateClientInfoResponseResult, x), from_none], self.result)
        result["error"] = from_union([lambda x: to_class(ClientUpdateClientInfoResponseError, x), from_none], self.error)
        result["id"] = from_union([to_float, from_none], self.id)
        result["jsonrpc"] = from_union([from_str, from_none], self.jsonrpc)
        return result
...
class UpdateClientInfo:
    ...
    def __init__(self, request: ClientUpdateClientInfoRequest, response: ClientUpdateClientInfoResponse) -> None:
        self.request = request
        self.response = response

    @staticmethod
    def from_dict(obj: Any) -> 'UpdateClientInfo':
        assert isinstance(obj, dict)
        request = ClientUpdateClientInfoRequest.from_dict(obj.get("request"))
        response = ClientUpdateClientInfoResponse.from_dict(obj.get("response"))
        return UpdateClientInfo(request, response)

    def to_dict(self) -> dict:
        result: dict = {}
        result["request"] = to_class(ClientUpdateClientInfoRequest, self.request)
        result["response"] = to_class(ClientUpdateClientInfoResponse, self.response)
        return result
...
class ClientController:
    ...
    def __init__(self, add_client: AddClient, find_or_create_client: FindOrCreateClient, update_client: UpdateClient, update_client_info: UpdateClientInfo) -> None:
        self.add_client = add_client
        self.find_or_create_client = find_or_create_client
        self.update_client = update_client
        self.update_client_info = update_client_info
    ...
    def from_dict(obj: Any) -> 'ClientController':
        ...
        update_client_info = UpdateClientInfo.from_dict(obj.get("update_client_info"))
        return ClientController(add_client, find_or_create_client, update_client, update_client_info)
    ...
    def to_dict(self) -> dict:
        ...
        result["update_client_info"] = to_class(UpdateClientInfo, self.update_client_info)
        return result
...
class Business5:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'Business5':
        assert isinstance(obj, dict)
        id = from_str(obj.get("id"))
        return Business5(id)
...
class CracCRACDistributedResourcesFreeByDateRequestParam:
    ...
    def __init__(self, business: Business5, resources: List[str], taxonomy: TentacledTaxonomy) -> None:
        self.business = business
        self.resources = resources
        self.taxonomy = taxonomy
    ...
    def from_dict(obj: Any) -> 'CracCRACDistributedResourcesFreeByDateRequestParam':
        assert isinstance(obj, dict)
        business = Business5.from_dict(obj.get("business"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["business"] = to_class(Business5, self.business)
...
class Business6:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'Business6':
        assert isinstance(obj, dict)
        id = from_str(obj.get("id"))
        return Business6(id)
...
class CracCRACResourcesFreeByDateV2RequestParam:
    ...
    def __init__(self, business: Business6, duration: float, durations: List[float], resources: List[str], taxonomy: IndigoTaxonomy) -> None:
        self.business = business
        self.duration = duration
    ...
    def from_dict(obj: Any) -> 'CracCRACResourcesFreeByDateV2RequestParam':
        assert isinstance(obj, dict)
        business = Business6.from_dict(obj.get("business"))
        duration = from_float(obj.get("duration"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["business"] = to_class(Business6, self.business)
        result["duration"] = to_float(self.duration)
