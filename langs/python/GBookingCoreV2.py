...
class AdditionalSettings:
    ...
    def from_dict(obj: Any) -> 'AdditionalSettings':
        ...
        return AdditionalSettings(appointment_extension_amount, appointment_extension_type)
...
class BusinessBackofficeConfiguration:
    ...
    def from_dict(obj: Any) -> 'BusinessBackofficeConfiguration':
        ...
        enable_master_importance = from_union([from_bool, from_none], obj.get("enableMasterImportance"))
        resource_timetable_type = from_union([ResourceTimetableType, from_none], obj.get("resourceTimetableType"))
        return BusinessBackofficeConfiguration(enable_master_importance, resource_timetable_type)
...
class CallbackWidgetConfiguration:
    ...
    def from_dict(obj: Any) -> 'CallbackWidgetConfiguration':
        ...
        return CallbackWidgetConfiguration(title1, title2)
...
class Consumable:
    ...
    def from_dict(obj: Any) -> 'Consumable':
        ...
        return Consumable(extra_id, name, quantity)
...
class Department:
    ...
    def from_dict(obj: Any) -> 'Department':
        ...
        name = from_str(obj.get("name"))
        return Department(id, department_id, name)
...
class MiniWidgetConfiguration:
    ...
    def from_dict(obj: Any) -> 'MiniWidgetConfiguration':
        ...
        title1 = from_union([from_str, from_none], obj.get("title1"))
        title2 = from_union([from_str, from_none], obj.get("title2"))
        return MiniWidgetConfiguration(fields, title1, title2)
...
class TaxonomiesComplex:
    ...
    def from_dict(obj: Any) -> 'TaxonomiesComplex':
        ...
        return TaxonomiesComplex(name, taxonomies)
...
class BookableDateRanges:
    ...
    def from_dict(obj: Any) -> 'BookableDateRanges':
        ...
        start = obj.get("start")
        return BookableDateRanges(enabled, end, start)
...
class ClientBlockingSettings:
    ...
    def from_dict(obj: Any) -> 'ClientBlockingSettings':
        ...
        return ClientBlockingSettings(appointment_client_block, appointment_client_block_days, appointment_client_block_text, block_if_future_record_exists, block_repeated_records_count, block_repeated_records_range, block_repeated_records_text)
...
class DiscountedPriceRounding:
    ...
    def from_dict(obj: Any) -> 'DiscountedPriceRounding':
        ...
        return DiscountedPriceRounding(rule, value)
...
class SocialSharing:
    ...
    def from_dict(obj: Any) -> 'SocialSharing':
        ...
        return SocialSharing(active, discount_amount, discount_enabled, discount_type, text, widget_text)
...
class WidgetConfiguration:
    ...
    def from_dict(obj: Any) -> 'WidgetConfiguration':
        ...
        bookable_date_ranges = from_union([BookableDateRanges.from_dict, from_none], obj.get("bookableDateRanges"))
        ...
        client_blocking_settings = from_union([ClientBlockingSettings.from_dict, from_none], obj.get("clientBlockingSettings"))
        ...
        discounted_price_rounding = from_union([DiscountedPriceRounding.from_dict, from_none], obj.get("discountedPriceRounding"))
        ...
        social_sharing = from_union([SocialSharing.from_dict, from_none], obj.get("socialSharing"))
    ...
    def to_dict(self) -> dict:
        ...
        result["bookableDateRanges"] = from_union([lambda x: to_class(BookableDateRanges, x), from_none], self.bookable_date_ranges)
        ...
        result["clientBlockingSettings"] = from_union([lambda x: to_class(ClientBlockingSettings, x), from_none], self.client_blocking_settings)
        ...
        result["discountedPriceRounding"] = from_union([lambda x: to_class(DiscountedPriceRounding, x), from_none], self.discounted_price_rounding)
        ...
        result["socialSharing"] = from_union([lambda x: to_class(SocialSharing, x), from_none], self.social_sharing)
...
class BusinessClass:
    ...
    def from_dict(obj: Any) -> 'BusinessClass':
        ...
        business_backoffice_configuration = from_union([BusinessBackofficeConfiguration.from_dict, from_none], obj.get("backoffice_configuration"))
        ...
        cabinets = from_union([lambda x: from_list(Cabinet.from_dict, x), from_none], obj.get("cabinets"))
        cabinets_enabled = from_union([from_bool, from_none], obj.get("cabinetsEnabled"))
        ...
        consumables = from_union([lambda x: from_list(Consumable.from_dict, x), from_none], obj.get("consumables"))
        ...
        departments = from_union([lambda x: from_list(Department.from_dict, x), from_none], obj.get("departments"))
        ...
        mini_widget_configuration = MiniWidgetConfiguration.from_dict(obj.get("mini_widget_configuration"))
        ...
        taxonomies_complex = from_union([lambda x: from_list(TaxonomiesComplex.from_dict, x), from_none], obj.get("taxonomiesComplex"))
        ...
        widget_configuration = WidgetConfiguration.from_dict(obj.get("widget_configuration"))
    ...
    def to_dict(self) -> dict:
        ...
        result["backoffice_configuration"] = from_union([lambda x: to_class(BusinessBackofficeConfiguration, x), from_none], self.business_backoffice_configuration)
        ...
        result["cabinets"] = from_union([lambda x: from_list(lambda x: to_class(Cabinet, x), x), from_none], self.cabinets)
        result["cabinetsEnabled"] = from_union([from_bool, from_none], self.cabinets_enabled)
        ...
        result["consumables"] = from_union([lambda x: from_list(lambda x: to_class(Consumable, x), x), from_none], self.consumables)
        ...
        result["departments"] = from_union([lambda x: from_list(lambda x: to_class(Department, x), x), from_none], self.departments)
        ...
        result["mini_widget_configuration"] = to_class(MiniWidgetConfiguration, self.mini_widget_configuration)
        ...
        result["taxonomiesComplex"] = from_union([lambda x: from_list(lambda x: to_class(TaxonomiesComplex, x), x), from_none], self.taxonomies_complex)
        ...
        result["widget_configuration"] = to_class(WidgetConfiguration, self.widget_configuration)
...
class BusinessGetProfileByIDResponseResult:
    ...
    def from_dict(obj: Any) -> 'BusinessGetProfileByIDResponseResult':
        assert isinstance(obj, dict)
        active = from_union([from_bool, from_none], obj.get("active"))
        business = from_union([from_none, from_float, from_int, from_bool, from_str, lambda x: from_list(lambda x: x, x), BusinessClass.from_dict], obj.get("business"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["active"] = from_union([from_bool, from_none], self.active)
        result["business"] = from_union([from_none, to_float, from_int, from_bool, from_str, lambda x: from_list(lambda x: x, x), lambda x: to_class(BusinessClass, x)], self.business)
...
class BusinessController:
    ...
    def from_dict(obj: Any) -> 'BusinessController':
        ...
        return BusinessController(get_profile_by_id)
...
class ResultBusiness:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ResultBusiness':
        assert isinstance(obj, dict)
        id = from_str(obj.get("id"))
        return ResultBusiness(id)
...
class ClientAddClientResponseResult:
    ...
    def from_dict(obj: Any) -> 'ClientAddClientResponseResult':
        assert isinstance(obj, dict)
        business = from_union([ResultBusiness.from_dict, from_none], obj.get("business"))
        client = Client.from_dict(obj.get("client"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["business"] = from_union([lambda x: to_class(ResultBusiness, x), from_none], self.business)
        result["client"] = to_class(Client, self.client)
