...
public class BusinessBackofficeConfiguration {
    ...
    private TentacledClientCancellationRestriction clientCancellationRestriction;
    ...
    private Boolean showGuaranteeLettersScreen;
    ...
    private FluffyTelemedApplication telemedApplication;
    ...
    public TentacledClientCancellationRestriction getClientCancellationRestriction() { return clientCancellationRestriction; }
    @JsonProperty("clientCancellationRestriction")
    public void setClientCancellationRestriction(TentacledClientCancellationRestriction value) { this.clientCancellationRestriction = value; }
    ...
    @JsonProperty("showGuaranteeLettersScreen")
    public Boolean getShowGuaranteeLettersScreen() { return showGuaranteeLettersScreen; }
    @JsonProperty("showGuaranteeLettersScreen")
    public void setShowGuaranteeLettersScreen(Boolean value) { this.showGuaranteeLettersScreen = value; }
    ...
    public FluffyTelemedApplication getTelemedApplication() { return telemedApplication; }
    @JsonProperty("telemedApplication")
    public void setTelemedApplication(FluffyTelemedApplication value) { this.telemedApplication = value; }
