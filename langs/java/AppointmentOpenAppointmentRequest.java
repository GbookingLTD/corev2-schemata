...
public class AppointmentOpenAppointmentRequest {
    private Cred cred;
    private BackofficeIDUnion id;
    private String jsonrpc;
    private String method;
    private OpenAppointmentParams params;
     ...
     */
    @JsonProperty("params")
    public OpenAppointmentParams getParams() { return params; }
    @JsonProperty("params")
    public void setParams(OpenAppointmentParams value) { this.params = value; }
}
