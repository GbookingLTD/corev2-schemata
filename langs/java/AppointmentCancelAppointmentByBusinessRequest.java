...
public class AppointmentCancelAppointmentByBusinessRequest {
    private Cred cred;
    private PurpleTimeFrameDate id;
    private String jsonrpc;
    private String method;
    private AppointmentCancelAppointmentByBusinessRequestParams params;
     ...
     */
    @JsonProperty("params")
    public AppointmentCancelAppointmentByBusinessRequestParams getParams() { return params; }
    @JsonProperty("params")
    public void setParams(AppointmentCancelAppointmentByBusinessRequestParams value) { this.params = value; }
}
