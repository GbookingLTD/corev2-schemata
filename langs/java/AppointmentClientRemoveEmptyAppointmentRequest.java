...
public class AppointmentClientRemoveEmptyAppointmentRequest {
    private Cred cred;
    private BackofficeIDUnion id;
    private String jsonrpc;
    private String method;
    private RemoveEmptyAppointment params;
     ...
     */
    @JsonProperty("params")
    public RemoveEmptyAppointment getParams() { return params; }
    @JsonProperty("params")
    public void setParams(RemoveEmptyAppointment value) { this.params = value; }
}
