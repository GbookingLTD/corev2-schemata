...
public class ClientFindOrCreateClientRequest {
    private Cred cred;
    private BackofficeIDUnion id;
    private String jsonrpc;
    private String method;
    private ClientFindOrCreateClientRequestParams params;
     ...
     */
    @JsonProperty("params")
    public ClientFindOrCreateClientRequestParams getParams() { return params; }
    @JsonProperty("params")
    public void setParams(ClientFindOrCreateClientRequestParams value) { this.params = value; }
}
