...
public class AppointmentGetAppointmentsByClientV2Request {
    private Cred cred;
    private BackofficeIDUnion id;
    private String jsonrpc;
    private String method;
    private AppointmentGetAppointmentsByClientV2RequestParams params;
     ...
     */
    @JsonProperty("params")
    public AppointmentGetAppointmentsByClientV2RequestParams getParams() { return params; }
    @JsonProperty("params")
    public void setParams(AppointmentGetAppointmentsByClientV2RequestParams value) { this.params = value; }
}
