...
public class AppointmentReserveAppointmentRequest {
    private Cred cred;
    private BackofficeIDUnion id;
    private String jsonrpc;
    private String method;
    private AppointmentReserve params;
     ...
     */
    @JsonProperty("params")
    public AppointmentReserve getParams() { return params; }
    @JsonProperty("params")
    public void setParams(AppointmentReserve value) { this.params = value; }
}
