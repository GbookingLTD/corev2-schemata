...
public class BusinessGetNetworkDataResponseResult {
    ...
    private List<PurpleBusiness> businesses;
    ...
    public List<PurpleBusiness> getBusinesses() { return businesses; }
    @JsonProperty("businesses")
    public void setBusinesses(List<PurpleBusiness> value) { this.businesses = value; }
