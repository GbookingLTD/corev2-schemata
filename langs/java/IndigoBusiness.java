...
public class IndigoBusiness {
    ...
    private List<PurpleBusinessTaxonomy> taxonomies;
    ...
    public List<PurpleBusinessTaxonomy> getTaxonomies() { return taxonomies; }
    @JsonProperty("taxonomies")
    public void setTaxonomies(List<PurpleBusinessTaxonomy> value) { this.taxonomies = value; }
