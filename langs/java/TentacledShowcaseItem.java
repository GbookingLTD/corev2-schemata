...
public class TentacledShowcaseItem {
    private String id;
    private List<IndecentAdditionalDuration> additionalDurations;
    ...
    public List<IndecentAdditionalDuration> getAdditionalDurations() { return additionalDurations; }
    @JsonProperty("additionalDurations")
    public void setAdditionalDurations(List<IndecentAdditionalDuration> value) { this.additionalDurations = value; }
