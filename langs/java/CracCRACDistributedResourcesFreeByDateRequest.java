...
public class CracCRACDistributedResourcesFreeByDateRequest {
    private Cred cred;
    private PurpleTimeFrameDate id;
    private String jsonrpc;
    private String method;
    private List<CracCRACDistributedResourcesFreeByDateRequestParam> params;
     ...
     */
    @JsonProperty("params")
    public List<CracCRACDistributedResourcesFreeByDateRequestParam> getParams() { return params; }
    @JsonProperty("params")
    public void setParams(List<CracCRACDistributedResourcesFreeByDateRequestParam> value) { this.params = value; }
}
