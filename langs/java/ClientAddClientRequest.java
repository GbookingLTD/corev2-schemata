...
public class ClientAddClientRequest {
    private Cred cred;
    private RequestTimeFrameDate id;
    private String jsonrpc;
    private String method;
    private ClientAddClientRequestParams params;
     ...
     */
    @JsonProperty("params")
    public ClientAddClientRequestParams getParams() { return params; }
    @JsonProperty("params")
    public void setParams(ClientAddClientRequestParams value) { this.params = value; }
}
