...
public class ClientUpdateClientInfoRequest {
    private Cred cred;
    private PurpleTimeFrameDate id;
    private String jsonrpc;
    private String method;
    private ClientUpdateClientInfoRequestParams params;
     ...
     */
    @JsonProperty("params")
    public ClientUpdateClientInfoRequestParams getParams() { return params; }
    @JsonProperty("params")
    public void setParams(ClientUpdateClientInfoRequestParams value) { this.params = value; }
}
