...
public class AppointmentResource {
    ...
    private String resourceExtraID;
     ...
     */
    @JsonProperty("extraId")
    public String getResourceExtraID() { return resourceExtraID; }
    @JsonProperty("extraId")
    public void setResourceExtraID(String value) { this.resourceExtraID = value; }
