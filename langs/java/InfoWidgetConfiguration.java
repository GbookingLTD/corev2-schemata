...
public class InfoWidgetConfiguration {
    ...
    private PurpleDiscountedPriceRounding discountedPriceRounding;
    ...
    @JsonProperty("bookableDateRanges")
    public void setBookableDateRanges(PurpleBookableDateRanges value) { this.bookableDateRanges = value; }
    ...
    public PurpleClientBlockingSettings getClientBlockingSettings() { return clientBlockingSettings; }
    @JsonProperty("clientBlockingSettings")
    public void setClientBlockingSettings(PurpleClientBlockingSettings value) { this.clientBlockingSettings = value; }
    ...
    public PurpleDiscountedPriceRounding getDiscountedPriceRounding() { return discountedPriceRounding; }
    @JsonProperty("discountedPriceRounding")
    public void setDiscountedPriceRounding(PurpleDiscountedPriceRounding value) { this.discountedPriceRounding = value; }
    ...
    public PurpleSocialSharing getSocialSharing() { return socialSharing; }
    @JsonProperty("socialSharing")
    public void setSocialSharing(PurpleSocialSharing value) { this.socialSharing = value; }
