...
public class HilariousBusiness {
    ...
    private List<FluffyBusinessTaxonomy> taxonomies;
    ...
    public List<FluffyBusinessTaxonomy> getTaxonomies() { return taxonomies; }
    @JsonProperty("taxonomies")
    public void setTaxonomies(List<FluffyBusinessTaxonomy> value) { this.taxonomies = value; }
